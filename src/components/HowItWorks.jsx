...
const HowItWorks = () => {
  return (
    <div
      ...
      style={{ textAlign: 'center', padding: '20px 90px' }}
    >
      <Title className='sectionTitle'>
        Sell your home for a competitive price in as few as 10 days, with no
        additional fees, agent commission, or prep-work.
      </Title>

      {/* Images centered above each step */}
      <div
        className='steps-wrapper DesktopSteps'
        style={{
          display: 'flex',
      ...
      >
        {stepsData.map((step, index) => (
          <div
            key={index}
            style={{ flex: 1, textAlign: 'center', maxWidth: '300px' }}
          >
